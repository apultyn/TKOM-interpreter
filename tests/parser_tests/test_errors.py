...
def test_stmt_with_ident_no_semicolon(mocked_error_handler, make_parser):
    ...
    check_error(
        mocked_error_handler, SyntaxException, (1, 6), msg="';' expected, got 'EOF'"
    )
...
def test_access_no_ident(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 10),
        msg="Identifier expected, got 'INT_LITERAL'",
    )
...
"""
    ...
    check_error(
        ...
        SyntaxException,
        (2, 7),
        msg="')' expected, got 'LEFT_CURLY_BRACKET'",
    )
...
def test_for_no_in(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 9),
        msg="'in' keyword expected, got 'LEFT_CURLY_BRACKET'",
    )
...
def test_return_no_semicolon(mocked_error_handler, make_parser):
    ...
    check_error(
        mocked_error_handler, SyntaxException, (1, 7), msg="';' expected, got 'EOF'"
    )
...
def test_block_wrong_statement(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 2),
        msg="'}' or statement expected, got 'INT_LITERAL'",
    )
...
def test_block_no_right_bracket(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 7),
        msg="'}' or statement expected, got 'EOF'",
    )
...
def test_list_no_right_bracket_empty(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 6),
        msg="']' or expression expected, got 'EOF'",
    )
...
def test_dict_wrong_elem(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 12),
        msg="'}' or ',' expected, got 'INT_LITERAL'",
    )
...
def test_func_nothing_after_comma(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 19),
        msg="Identifier expected, got 'RIGHT_BRACKET'",
    )
...
def test_func_no_right_bracket_empty(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 14),
        msg="')' or identifier expected, got 'EOF'",
    )
...
def test_linq_no_in(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 14),
        msg="'in' keyword expected, got 'SELECT_KEYWORD'",
    )
...
def test_linq_no_select(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 21),
        msg="'select' keyword expected, got 'SEMICOLON'",
    )
...
def test_linq_order_no_by(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 45),
        msg="'by' keyword expected, got 'SEMICOLON'",
    )
...
def test_linq_descending_no_order(mocked_error_handler, make_parser):
    ...
    check_error(
        ...
        SyntaxException,
        (1, 39),
        msg="';' expected, got 'DESCENDING_KEYWORD'",
    )
...
def test_item_no_right_bracket(mocked_error_handler, make_parser):
    ...
    check_error(
        mocked_error_handler, SyntaxException, (1, 17), msg="')' expected, got 'EOF'"
    )
